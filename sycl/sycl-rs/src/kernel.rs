...
use crate::Result;
use bytemuck::Pod;
use sycl_rs_sys::{kernel_bundle::ffi, types};
...
unsafe impl KernelArgumentList<0> for () {
...
pub use sycl_rs_derive::KernelArgumentList;

use sycl_rs_derive::impl_arg_list_for_tuples;
